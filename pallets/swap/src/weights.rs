...
//! DATE: 2023-04-11, STEPS: `100`, REPEAT: 200, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> super::WeightInfo for WeightInfo<T> {
	...
	fn add_liquidity() -> Weight {
		// Minimum execution time: 76_492 nanoseconds.
		Weight::from_ref_time(77_555_000)
	...
	fn remove_liquidity() -> Weight {
		// Minimum execution time: 86_905 nanoseconds.
		Weight::from_ref_time(88_417_000)
			.saturating_add(T::DbWeight::get().reads(10))
			.saturating_add(T::DbWeight::get().writes(9))
	}
	// Storage: Swap Pools (r:1 w:1)
	...
	fn create_pool() -> Weight {
		// Minimum execution time: 89_373 nanoseconds.
		Weight::from_ref_time(90_393_000)
			.saturating_add(T::DbWeight::get().reads(13))
			.saturating_add(T::DbWeight::get().writes(12))
	}
	// Storage: Swap ProtocolFee (r:0 w:1)
	fn update_protocol_fee() -> Weight {
		// Minimum execution time: 13_038 nanoseconds.
		Weight::from_ref_time(13_961_000)
